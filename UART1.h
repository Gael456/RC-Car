...
/**
 * @brief The UART1_Input_Unsigned_Decimal function reads an unsigned decimal number from the UART receive buffer.
 *
 * This function reads characters from the UART receive buffer in the serial terminal
 * until a carriage return (CR) character is encountered.
...
/**
 * @brief The UART1_Output_Unsigned_Decimal function transmits an unsigned decimal number via UART to the serial terminal.
 *
...
/**
 * @brief The UART1_Input_Unsigned_Hexadecimal function reads an unsigned hexadecimal number from the UART receive buffer.
 *
 * This function reads characters from the UART receive buffer in the serial terminal
 * until a carriage return (CR) character is encountered.
...
/**
 * @brief The UART1_Output_Unsigned_Hexadecimal function transmits an unsigned hexadecimal number via UART to the serial terminal.
 *
...
/**
 * @brief The UART1_Output_Newline function transmits the carriage return (CR) and line feed (LF) to go to a new line.
 *
 * @param None
 *
 * @return None
